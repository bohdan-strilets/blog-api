  ...
  confirmEmail(email: string, activationToken: string): EmailType {
    return {
      ...
      <div>
        ...
        <br /><br />
        <a target="_blank" href="${process.env.API_URL}/api/v1/user/verification-email/${activationToken}">Finish registration</a>
        <br />
        <a target="_blank" href="${process.env.API_URL}/api/v1/user/verification-email/${activationToken}">${process.env.API_URL}/api/v1/user/verification-email/${activationToken}</a>
      </div>
    `,
    };
  }
